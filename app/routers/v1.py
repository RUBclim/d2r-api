...
async def get_station_rendered_metadata(
    ...
    """API-endpoint for retrieving rendered metadata from a specific station. This
    returns an HTML page with the metadata information.
    """
    station = (
        await db.execute(
            select(Station)
